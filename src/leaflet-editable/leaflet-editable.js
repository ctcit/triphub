...
(function(factory, window) {
    ...
    L.Editable = L.Evented.extend({
        ...
        initialize: function(map, options) {
            ...
            // This is a known issue with prod builds using webpack and this workaround is suggested by ngx-leaflet
    ...
    var PolygonMixin = {
        ...
        shapeAt: function(latlng, latlngs) {
            ...
            if (!latlngs.length) return shape;
                ...
                for (var i = 0; i < latlngs.length; i++) if (this.isInLatLngs(latlng, latlngs[i][0])) return latlngs[i];
            return shape;
        },
