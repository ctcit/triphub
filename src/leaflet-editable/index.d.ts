...
// TODO: - Extracted from NPM package and modified slightly to match latest leaflet
// NOTE: Ensure at least one refence to L. in file to avoid next line (import * as L from 'leaflet';) from being removed
declare module 'leaflet' {
    ...
    interface Editable /*extends Mixin.LeafletMixinEvents*/ {
         ...
         * click. If options is given, it will be passed to the polygon class constructor.
         */
        startRectangle(latLng?: LatLng, options?: PolylineOptions): Polygon;
