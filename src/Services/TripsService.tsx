...
export class TripsService {
    ...
    public static async getTripParticipant(id: number, participantId: number): Promise<IParticipant> {
        return apiCall('POST', BaseUrl + '/trips/' + id + '/participants/' + participantId)
            .then((participants: IParticipant[]) => participants[0])
    }
